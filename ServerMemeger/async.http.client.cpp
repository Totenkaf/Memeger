...
public:
    ...
    // std::string user_login="Dick";
    // std::string user_password="qwerty";
    // std::string id="hkfwhkefhk2332";
    //  std::string status="passive";
	// std::string body = "{\"id\":\"" + id + "\"," + "\"login\":\"" + user_login + "\"," + "\"password\":\"" + user_password +  "\"," +"\"status\":\"" +status+"\"}";
    // request_.version(10);
