...
void Client::login(const std::string user_login, const std::string user_password)
{
    std::string path = "/get_user/";
...
void Client::start_chat(const std::string user_1, const std::string user_2)
{
    std::string path = "/add_chat/";
    std::string chat_name = "Dialog";
    std::string size = "2";
    std::string body = "{\"chat_name\":\"" + chat_name + "\"," + "\"participant_1\":\"" + user_1 + "\"," + "\"participant_2\":\"" + user_2 + "\"," + "\"size\":\"" + size + "\"}";
    request_.version(10);
    request_.method(http::verb::post);
    request_.target(path);
    request_.set(http::field::content_length, std::to_string(body.length()));
...
void Client::send_message(std::string user_login, const std::string message)
{
    std::string path = "/add_message/";
    std::string chat_name="Dialog";

    std::string body = "{\"login\":\"" + user_login + "\"," + "\"chat_name\":\"" + chat_name + "\"," + "\"content\":\"" + message + "\"}";
    request_.version(10);
    request_.method(http::verb::post);
    request_.target(path);
    request_.set(http::field::content_length, std::to_string(body.length()));
...
void Client::get_last_messages()
{
    std::string path = "/get_last_messages/";
    std::string chat_name="Dialog";
    std::string num_of_messages="10";
