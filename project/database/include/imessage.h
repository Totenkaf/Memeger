...
public:
  ...
  virtual auto set_message_id(const std::string &message_id) -> int = 0;

  [[nodiscard]] virtual auto get_parent_chat_id() const -> std::string = 0;
  virtual auto set_parent_chat_id(const std::string &parent_chat_id) -> int = 0;

  [[nodiscard]] virtual auto get_sender_id() const -> std::string = 0;
  virtual auto set_sender_id(const std::string &sender_id) -> int = 0;
  ...
  virtual auto set_message_content(const std::string &text_message) -> int = 0;

  [[nodiscard]] virtual auto get_read_status() const -> bool = 0;
  virtual auto set_read_status(bool is_read) -> int = 0;
