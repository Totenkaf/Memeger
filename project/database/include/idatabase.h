...
private:
  ...
  update(const std::string &table, const std::vector<std::string> &table_fields,
         const std::vector<std::string> &values, const std::string &where)
      -> int = 0;
  [[nodiscard]] virtual auto
  insert(const std::string &table, const std::vector<std::string> &table_fields,
         const std::vector<std::string> &values,
         std::vector<std::string> &output_params) -> int = 0;
  [[nodiscard]] virtual auto delete_(const std::string &table,
                                     const std::string &where) -> int = 0;
  [[nodiscard]] virtual auto select(const std::string &table,
