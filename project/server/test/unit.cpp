...
TEST_F(DataBaseEnvironment, check_user) {
  ...
  std::string body = "{\"login\":\"" + user_login + "\"," + "\"chat_name\":\"" +
                     chat_name + "\"," + "\"content\":\"" + content + "\"}";
  ...
  // &request_=obj_request.request_;
  // boost::beast::http::response<boost::beast::http::string_body>
  // &res=obj_response.res; std::string
  // &response_body=obj_response.response_body;
...
TEST_F(DataBaseEnvironment, add_user) {
  ...
  //   auto s =
  //   std::make_shared<DataBaseEnvironment3::DataBaseEnvironment>("localhost",
  //   "8080", num_threads);
  ...
  std::string body = "{\"login\":\"" + user_login + "\"," + "\"password\":\"" +
                     user_password + "\"}";
...
TEST_F(DataBaseEnvironment, change_login) {
  ...
  std::string body = "{\"login\":\"" + user_login + "\"," + "\"new_log\":\"" +
                     new_user_login + "\"}";
...
TEST_F(DataBaseEnvironment, change_password) {
  ...
  std::string body = "{\"login\":\"" + user_login + "\"," + "\"new_pass\":\"" +
                     new_user_pass + "\"}";
  ...
  bool check =
      obj_response.usr.change_password(obj_request, obj_response, database);
...
TEST_F(DataBaseEnvironment, change_user_status) {
  ...
  std::string body =
      "{\"login\":\"" + user_login + "\"," + "\"status\":\"" + status + "\"}";
  ...
  bool check =
      obj_response.usr.change_user_status(obj_request, obj_response, database);
...
TEST_F(DataBaseEnvironment, change_chat_name) {
  ...
  bool check =
      obj_response.cht.change_chat_name(obj_request, obj_response, database);
